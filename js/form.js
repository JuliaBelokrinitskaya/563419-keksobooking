...
(function () {
  ...
  var avatarPreview = noticeFormElement.querySelector('.ad-form-header__preview img');
  var avatarChooser = noticeFormElement.querySelector('.ad-form__field input[type=file]');
  var photoContainer = noticeFormElement.querySelector('.ad-form__photo-container');
  var photoPreview = noticeFormElement.querySelector('.ad-form__photo');
  var photoChooser = noticeFormElement.querySelector('.ad-form__upload input[type=file]');
